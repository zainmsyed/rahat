...
- 2026-07-21: Retired. The initial implementation proved the technical plumbing works but the UX model was wrong for the target audience (non-technical new mothers): it exposed internal details like raw Telegram chat IDs and infra state. Superseded by Stories 010 (guided core onboarding), 011 (guided Telegram connection), and 012 (guided Google Calendar connection). The implementation was rolled back to the pre-Story-006 checkout before replanning.
